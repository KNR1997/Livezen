...
import { useTypes, useTypes2, useTypes_v2 } from '@/framework/type';
...
const GroupsDropdownMenu: React.FC<GroupsDropdownMenuProps> = ({ variant }) => {
  ...
  // const { types_v2 }: any = useTypes_v2({
  //   limit: TYPES_PER_PAGE,
  // });

  // console.log('types_v2: ', types_v2)
  ...
  return (
    <div>
      ...
      {/* <GroupsMenu groups={types_v2} defaultGroup={homePage} variant={variant} /> */}
    </div>
  );
};
